...
// in zishan_goldkinentask/test/mocks/mock_post_repository.dart.
...
import 'package:zishan_goldkinentask/core/error/failures.dart' as _i5;
import 'package:zishan_goldkinentask/features/post/domain/entities/post.dart'
    as _i6;
import 'package:zishan_goldkinentask/features/post/domain/repositories/post_repository.dart'
    as _i3;
...
class MockPostRepository extends _i1.Mock implements _i3.PostRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.Post>>> searchPosts(
          String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #searchPosts,
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.Post>>> getPostsByUserId(
          int? userId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPostsByUserId,
